    ...
    <div class="h-full flex flex-col">
      ...
      <nav class="flex-1 p-4 space-y-1.5 overflow-y-auto custom-scrollbar">
        <NuxtLink
          ...
          active-class="bg-gradient-to-r from-zinc-600/30 to-zinc-700/20 text-white border-l-2 border-zinc-500 shadow-lg shadow-zinc-300/20"
        >
          <div class="w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-200 group-hover:scale-110 group-hover:rotate-3" style="background: linear-gradient(135deg, rgba(113, 113, 122, 0.15) 0%, rgba(82, 82, 91, 0.08) 100%);">
        <svg class="w-5 h-5" style="color: #a1a1aa;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <NuxtLink
          ...
          @click="closeSidebar"
          class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-zinc-300 hover:text-white transition-all duration-200 group hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5"
          active-class="bg-gradient-to-r from-pink-600/30 to-pink-700/20 text-white border-l-2 border-pink-500 shadow-lg shadow-pink-500/20"
        >
        ...
        <NuxtLink
          ...
          @click="closeSidebar"
          class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-zinc-300 hover:text-white transition-all duration-200 group hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5"
          active-class="bg-gradient-to-r from-amber-600/30 to-amber-700/20 text-white border-l-2 border-amber-500 shadow-lg shadow-amber-500/20"
        >
        ...
        <NuxtLink
          ...
          @click="closeSidebar"
          class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-zinc-300 hover:text-white transition-all duration-200 group hover:bg-gradient-to-r hover:from-white/10 hover:to-white/5"
          active-class="bg-gradient-to-r from-yellow-600/30 to-yellow-700/20 text-white border-l-2 border-yellow-500 shadow-lg shadow-yellow-500/20"
        >
          <div class="w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-200 group-hover:scale-110 group-hover:rotate-3" style="background: linear-gradient(135deg, rgba(234, 179, 8, 0.15) 0%, rgba(202, 138, 4, 0.08) 100%);">
        <svg class="w-5 h-5" style="color: #facc15;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
